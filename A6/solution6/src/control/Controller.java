...
import view.InvaderCountWindow;
...
public class Controller implements KeyListener, ActionListener, GameObserver {
     ...
     */
    private InvaderCountWindow invaderCountWindow;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionCommand.equals("newgame")) {
            ...
            invaderCountWindow = new InvaderCountWindow(gameInfo);
            invaderCountWindow.setLocation(WIDTH, 0);
        ...
        if (gameInfo.isOver()) {
            ...
            Timer t = new Timer(2500, new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    invaderCountWindow.setVisible(false);
                }
            });
            /*
