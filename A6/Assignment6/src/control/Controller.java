...
import invaderView.invaderView;
...
public class Controller implements KeyListener, ActionListener, GameObserver {
    ...
    /**
     * Frame that holds the additional invader window, containing the number of 
     * remaining invaders.
     */
    private invaderView iview;
    ...
    public void start() {
        ...
        // Creates a new window for the Invader remaining window.
        iview = new invaderView(450, 425);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionCommand.equals("newgame")) {
            ...
            iview.showInvaderView(gameInfo);
